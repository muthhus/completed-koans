...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # passes around a memo object and performs the action for each item.
    # of course, you could just use inject(&:+) or reduce(&:*) etc...
  end
  ...
  # RM hmm passing a block into the open instead of creating a local?
end
